...
namespace RenderEngineDesktop.Models.Process
{
    ...
    /// </summary>
    public class GenericProcessModel : ISource, ITemplate, IOutlineColorComponent, IPercentTranslation, IPercentage, ICulture, IZipFile, ILeads, IMaximumInPixels, IOutputFile, IOutputFiles, IWatermark
    {
