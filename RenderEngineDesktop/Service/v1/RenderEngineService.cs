...
namespace RenderEngineDesktop.Service.v1;

internal class RenderEngineService : RES.V1.IRenderEngineService
{
    ...
    private async Task Invoke(Func<RES.V1.IRenderEngineService, Task> invoke)
    {
        using var client = new RES.V1.RenderEngineServiceClient(Binding(), EndpointAddress());
    ...
    private async Task<T> Invoke<T>(Func<RES.V1.IRenderEngineService, Task<T>> invoke)
    {
        using var client = new RES.V1.RenderEngineServiceClient(Binding(), EndpointAddress());
